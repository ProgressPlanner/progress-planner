 ...
 */
class YoastCornerstoneWorkoutTask extends TaskProvider {
	...
	async shouldAddTask( taskData = {} ) {
		try {
			...
			console.error(
				'Error checking Yoast Cornerstone Workout task condition:',
				error
			);
			return false;
		}
...
registerTask( YoastCornerstoneWorkoutTask );

export default YoastCornerstoneWorkoutTask;
