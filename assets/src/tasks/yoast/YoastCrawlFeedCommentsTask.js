 ...
 */
class YoastCrawlFeedCommentsTask extends InteractiveTaskProvider {
	...
	static externalLinkUrl =
		'https://prpl.fyi/yoast-crawl-optimization-feed-global-comments';
	...
	async shouldAddTask( taskData = {} ) {
		try {
			...
			console.error(
				'Error checking Yoast Crawl Feed Comments task condition:',
				error
			);
			return false;
		}
	...
	async getTaskDetails( taskData = {} ) {
		const taskDetails = this.buildTaskDetails( taskData, {
			...
			url: this.buildAdminUrl(
				'admin.php?page=wpseo_page_settings#/crawl-optimization#input-wpseo-remove_feed_global_comments'
			),
		} );
...
registerTask( YoastCrawlFeedCommentsTask );

export default YoastCrawlFeedCommentsTask;
