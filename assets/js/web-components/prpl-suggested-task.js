			...
			switch ( actionType ) {
				case 'snooze':
					...
					const date = new Date(
						...
						.toISOString()
						.split( '.' )[ 0 ];
					const snoozePost = new wp.api.models.Prpl_recommendations( {
						id: post_id,
						status: 'future',
						date,
						date_gmt: date,
				...
				case 'complete':
					...
					const completePost = new wp.api.models.Prpl_recommendations(
						{
							id: post_id,
				...
				case 'pending':
					const pendingPost = new wp.api.models.Prpl_recommendations(
						{
							id: post_id,
							status: 'publish',
						}
				...
				case 'delete':
					const deletePost = new wp.api.models.Prpl_recommendations( {
						id: post_id,
						status: 'trash',
					} );
