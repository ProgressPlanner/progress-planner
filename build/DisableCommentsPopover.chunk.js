"use strict";
(globalThis["webpackChunkprogress_planner"] = globalThis["webpackChunkprogress_planner"] || []).push([["DisableCommentsPopover"],{

/***/ "./assets/src/components/Popovers/DisableCommentsPopover.js":
/*!******************************************************************!*\
  !*** ./assets/src/components/Popovers/DisableCommentsPopover.js ***!
  \******************************************************************/
...
/* harmony export */   "default": () => (/* binding */ DisableCommentsPopover)
/* harmony export */ });
...
function DisableCommentsPopover({
  task,
  onSubmit,
  onClose
}) {
  ...
  const handleSubmit = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async e => {
    ...
    try {
      ...
      if (taskId === 'disable-comments') {
        await (0,_hooks_usePopoverForms__WEBPACK_IMPORTED_MODULE_3__.submitSiteSettings)({
...
//# sourceMappingURL=DisableCommentsPopover.chunk.js.map