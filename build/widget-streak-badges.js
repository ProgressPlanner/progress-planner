"use strict";
(globalThis["webpackChunkprogress_planner"] = globalThis["webpackChunkprogress_planner"] || []).push([["widget-streak-badges"],{
...
/***/ "./assets/src/widgets/StreakBadges/index.js":
/*!**************************************************!*\
  !*** ./assets/src/widgets/StreakBadges/index.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function getRemainingText(remaining) {
  return (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)(/* translators: %s: The remaining number of weeks. */
  (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__._n)('%s week to go to complete this streak!', '%s weeks to go to complete this streak!', remaining, 'progress-planner'), remaining);
}
...
function StreakBadges({
  ...
  const widgetTitle = config?.title || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Your streak badges', 'progress-planner');
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_components_WidgetHeader__WEBPACK_IMPORTED_MODULE_4__["default"], {
      ...
      tooltipContent: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Your streak badges are based on the amount of website maintenance work you have done over the past 30 days.', 'progress-planner')
      ...
      introText: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Execute at least one website maintenance task every week.', 'progress-planner'),
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__.doAction)('prpl.dashboard.registerWidget', {
  ...
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Your streak badges', 'progress-planner'),
  infoIconSvg: '' // Can be fetched from REST API if needed for branding
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (StreakBadges);
...
/******/ var __webpack_exports__ = (__webpack_exec__("./assets/src/widgets/StreakBadges/index.js"));
/******/ }
]);
//# sourceMappingURL=widget-streak-badges.js.map