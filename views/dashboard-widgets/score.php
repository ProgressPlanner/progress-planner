...
<?php if ( \current_user_can( 'manage_options' ) ) : ?>
	<div class="prpl-dashboard-widget-footer">
		...
		<div>
			<?php $prpl_pending_celebration_tasks = \progress_planner()->get_recommendations()->get( [ 'post_status' => 'pending_celebration' ] ); ?>
			<?php if ( 0 < count( $prpl_pending_celebration_tasks ) ) : ?>
				<?php
