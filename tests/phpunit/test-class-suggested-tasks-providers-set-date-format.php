<?php
/**
 * Class Suggested_Tasks_Providers_Set_Date_Format_Test
 *
...
/**
 * Suggested_Tasks_Providers_Set_Date_Format_Test test case.
 */
class Suggested_Tasks_Providers_Set_Date_Format_Test extends \WP_UnitTestCase {

	/**
	 * Set_Date_Format instance.
	 *
	 * @var Set_Date_Format
	 */
	protected $provider;
	...
	public function setUp(): void {
		parent::setUp();
		$this->provider = new Set_Date_Format();
	}
