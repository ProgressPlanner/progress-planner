...
final class Monthly extends Badge {
	...
	public static function init_badges() {
		...
		$start_date      = $activation_date < new \DateTime( 'first day of November 2024' ) // When badges were introduced.
			? $activation_date->modify( 'first day of November 2024' )
			: $activation_date->modify( 'first day of this month' );
