...
class Crawl_Settings extends Yoast_Provider {
	...
	public function get_title() {
		return \esc_html__( 'Yoast SEO: optimize your crawl settings', 'progress-planner' );
	}
	...
	public function get_description() {
		return \esc_html__( 'Yoast SEO can block search engines from crawling unnecessary pages.', 'progress-planner' ) .
