...
class Fewer_Tags extends Tasks {
	...
	protected function get_description() {
		return \sprintf(
			...
			'<a href="' . \esc_url( \progress_planner()->get_ui__branding()->get_url( 'https://prpl.fyi/install-fewer-tags' ) ) . '" target="_blank" data-prpl_accessibility_text="' . \esc_attr__( 'Read more about the Fewer Tags plugin', 'progress-planner' ) . '">' . \esc_html__( 'Read more', 'progress-planner' ) . '</a>'
		);
	}
