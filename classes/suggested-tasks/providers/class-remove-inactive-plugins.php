...
class Remove_Inactive_Plugins extends Tasks {
	...
	protected function get_description() {
		return \sprintf(
			...
			'<a href="' . \esc_url( \progress_planner()->get_ui__branding()->get_url( 'https://prpl.fyi/remove-inactive-plugins' ) ) . '" target="_blank">' . \esc_html__( 'removing any plugins', 'progress-planner' ) . '</a>',
		);
	}
