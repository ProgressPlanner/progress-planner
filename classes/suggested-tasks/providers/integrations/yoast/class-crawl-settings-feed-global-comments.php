...
class Crawl_Settings_Feed_Global_Comments extends Yoast_Provider {
	...
	protected function get_description() {
		return \sprintf(
			...
			'<a href="' . \esc_url( \progress_planner()->get_ui__branding()->get_url( 'https://prpl.fyi/yoast-crawl-optimization-feed-global-comments' ) ) . '" target="_blank" data-prpl_accessibility_text="' . \esc_attr__( 'Read more about the Yoast SEO Crawl Optimization Feed Global Comments', 'progress-planner' ) . '">' . \esc_html__( 'Read more', 'progress-planner' ) . '</a>'
		);
	}
