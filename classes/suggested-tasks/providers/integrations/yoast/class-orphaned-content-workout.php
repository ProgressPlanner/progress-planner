...
class Orphaned_Content_Workout extends Yoast_Provider {
	...
	protected function get_description() {
		return \sprintf(
			...
			'<a href="' . \apply_filters( 'progress_planner_task_description_link', 'https://prpl.fyi/run-orphaned-content-workout', $this->get_task_id(), $this->get_provider_id() ) . '" target="_blank"  data-prpl_accessibility_text="' . \esc_attr__( 'Learn more about the Yoast SEO Orphaned Content Workout', 'progress-planner' ) . '">' . \esc_html__( 'Lean more', 'progress-planner' ) . '</a>'
		);
	}
