...
class Orphaned_Content_Workout extends Tasks {
	...
	public function get_description( $task_id = '' ) {
		return sprintf(
			...
			'<a href="https://prpl.fyi/yoast-orphaned-content" target="_blank"  data-prpl_accessibility_text="' . \esc_attr__( 'Read more about the Yoast SEO Orphaned Content Workout', 'progress-planner' ) . '">' . \esc_html__( 'Lean more', 'progress-planner' ) . '</a>'
		);
	}
