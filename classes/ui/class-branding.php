...
final class Branding {
	...
	public function get_api_data(): array {
		...
		return $this->get_response_from_api();
	}
	 ...
	 * @return array
	 */
	public function get_response_from_api(): array {
		$response = \wp_remote_get( 'https://progressplanner.com/wp-json/wp/v2/pp-branding/' . $this->get_branding_id() );
	...
	public function get_admin_menu_icon(): string {
		...
		$admin_menu_icon_id = $this->get_api_data()['acf']['logo'];
	...
	public function get_ravi_name(): string {
		$default  = 'Ravi';
		$api_name = $this->get_api_data()['acf']['ravis_name'];
